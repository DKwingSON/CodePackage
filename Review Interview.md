- [分布式架构与PHP](#分布式架构与php)
  - [1. <a name=''></a>什么是服务注册与服务发现？](#1-什么是服务注册与服务发现)
  - [2. <a name='-1'></a>分布一致性算法：](#2-分布一致性算法)
  - [3. <a name='Sentinel'></a>Sentinel系统](#3-sentinel系统)
    - [3.1. <a name='Sentinel-1'></a>**Sentinel集群故障检测**](#31-sentinel集群故障检测)
    - [3.2. <a name='Sentinel-1'></a>**Sentinel集群故障转移**](#32-sentinel集群故障转移)
  - [4. <a name='Split-Brain'></a>脑裂（Split-Brain）](#4-脑裂split-brain)
  - [5. <a name='CDNCDN'></a>静态资源上传CDN后，向CDN访问该资源怎么做？](#5-静态资源上传cdn后向cdn访问该资源怎么做)
  - [6. <a name='Nginx'></a>Nginx模式的常见复杂均衡方式](#6-nginx模式的常见复杂均衡方式)
  - [7. <a name='PHP'></a>PHP魔术方法](#7-php魔术方法)
- [C++](#c)
  - [8. <a name='2Gmalloc20Gnew20G'></a>在一台内存为2G的机器上，malloc(20G) 会怎样？如果是new(20G) 会怎样？](#8-在一台内存为2g的机器上malloc20g-会怎样如果是new20g-会怎样)
  - [9. <a name='Functor'></a>Functor 仿函数](#9-functor-仿函数)
  - [10. <a name='NewDelete'></a>New, Delete：](#10-new-delete)
  - [11. <a name='CforkUnix'></a>C++的fork()? Unix下的函数](#11-c的fork-unix下的函数)
  - [12. <a name='C'></a>C++ 如何申请和释放一个数组？](#12-c-如何申请和释放一个数组)
  - [13. <a name='Ccasthttps:www.cnblogs.comwelfarearticles336091.html'></a>C++的四种cast操作符的](#13-c的四种cast操作符的)
    - [13.1. <a name='C-1'></a>C风格转换](#131-c风格转换)
    - [13.2. <a name='C-1'></a>C++风格转换](#132-c风格转换)
  - [14. <a name='C-1'></a>C++程序内存布局](#14-c程序内存布局)
  - [15. <a name='CSTLallocator'></a>C++ STL allocator：](#15-c-stl-allocator)
  - [16. <a name='Cnullnullptr'></a>C++中的null nullptr](#16-c中的null-nullptr)
  - [17. <a name='CJava'></a>C++类三种方式控制权限总结如下，这与Java中的三种对应的访问权限是一样的。](#17-c类三种方式控制权限总结如下这与java中的三种对应的访问权限是一样的)
  - [18. <a name='C11'></a>C++11 自动推断类型特性：](#18-c11-自动推断类型特性)
  - [19. <a name='CString2021'></a>C++的String深入讨论（百度2021秋招）](#19-c的string深入讨论百度2021秋招)
  - [20. <a name='CSTLmap'></a>C++中STL的map不同插入模式的性能对比](#20-c中stl的map不同插入模式的性能对比)
  - [21. <a name='STLunordered_map'></a>STL中的unordered_map怎么避免冲突？](#21-stl中的unordered_map怎么避免冲突)
  - [22. <a name='C-1'></a>C++智能指针：](#22-c智能指针)
    - [22.1. <a name='C-1'></a>C++引用计数（智能指针相关）](#221-c引用计数智能指针相关)
  - [23. <a name='C-1'></a>C++ 中的存储周期：](#23-c-中的存储周期)
  - [24. <a name='C-1'></a>C++函数模板的实现](#24-c函数模板的实现)
  - [25. <a name='C-1'></a>C++内存布局](#25-c内存布局)
- [计算机网络](#计算机网络)
  - [26. <a name='TCP'></a>为什么 TCP 建立连接需要三次握手](#26-为什么-tcp-建立连接需要三次握手)
  - [27. <a name='-1'></a>网络地址分类](#27-网络地址分类)
  - [28. <a name='-1'></a>网络掩码](#28-网络掩码)
  - [29. <a name='Nagle'></a>Nagle 算法](#29-nagle-算法)
  - [30. <a name='TCP-1'></a>TCP 协议粘包问题](#30-tcp-协议粘包问题)
  - [31. <a name='TCP-1'></a>TCP第三次握手失败后怎么办？](#31-tcp第三次握手失败后怎么办)
  - [32. <a name='TCP-1'></a>TCP滑动窗口结构](#32-tcp滑动窗口结构)
    - [32.1. <a name='-1'></a>拥塞控制和流量控制的区别](#321-拥塞控制和流量控制的区别)
  - [33. <a name='CA'></a>浏览器是如何对CA证书进行验证的？](#33-浏览器是如何对ca证书进行验证的)
  - [34. <a name='-1'></a>常见的网络协议报头](#34-常见的网络协议报头)
    - [34.1. <a name='TCP-1'></a>TCP报头](#341-tcp报头)
    - [34.2. <a name='UDP'></a>UDP报头](#342-udp报头)
    - [34.3. <a name='IP'></a>IP数据包报头](#343-ip数据包报头)
    - [34.4. <a name='-1'></a>**以太网的帧格式**](#344-以太网的帧格式)
  - [35. <a name='HTTPS'></a>HTTPS握手](#35-https握手)
  - [36. <a name='TCP-1'></a>TCP拥塞避免一图流](#36-tcp拥塞避免一图流)
  - [37. <a name='-1'></a>网络协议中的缩写](#37-网络协议中的缩写)
  - [38. <a name='GetPost'></a>Get与Post的对比](#38-get与post的对比)
  - [39. <a name='HTTPHeader'></a>HTTP Header的内容](#39-http-header的内容)
- [操作系统](#操作系统)
  - [40. <a name='-1'></a>怎样理解阻塞非阻塞与同步异步的区别？](#40-怎样理解阻塞非阻塞与同步异步的区别)
  - [41. <a name='-1'></a>惊群效应是什么](#41-惊群效应是什么)
  - [42. <a name='-1'></a>**什么是线程安全？**](#42-什么是线程安全)
  - [43. <a name='OS'></a>OS的分级保护域](#43-os的分级保护域)
  - [44. <a name='-1'></a>操作系统怎么管理，组织内存，申请一块内存的时候究竟发生了什么？](#44-操作系统怎么管理组织内存申请一块内存的时候究竟发生了什么)
  - [45. <a name='-1'></a>操作系统从一个文件名，读取到具体的文件内容，实际干了什么事情？★★★★](#45-操作系统从一个文件名读取到具体的文件内容实际干了什么事情)
  - [46. <a name='-1'></a>硬链接与软链接](#46-硬链接与软链接)
  - [47. <a name='-1'></a>**异步异常**](#47-异步异常)
  - [48. <a name='LinuxIO'></a>Linux系统之IO多路复用](#48-linux系统之io多路复用)
  - [49. <a name='-1'></a>堆与栈的区别](#49-堆与栈的区别)
  - [50. <a name='-1'></a>内存碎片产生原因及终极解决办法](#50-内存碎片产生原因及终极解决办法)
- [算法与数据结构](#算法与数据结构)
  - [51. <a name='-1'></a>**回调函数和钩子函数的区别**](#51-回调函数和钩子函数的区别)
  - [52. <a name='AVLBBTrie'></a>AVL树，红黑树，B树，B+树，Trie树都分别应用在哪些现实场景中？](#52-avl树红黑树b树b树trie树都分别应用在哪些现实场景中)
  - [53. <a name='1TB32GB'></a>海量数据排序——如果有1TB的数据需要排序，但只有32GB的内存如何排序处理？](#53-海量数据排序如果有1tb的数据需要排序但只有32gb的内存如何排序处理)
  - [54. <a name='-1'></a>*布隆过滤器*的原理，使用场景和注意事项](#54-布隆过滤器的原理使用场景和注意事项)
    - [54.1. <a name='-1'></a>最佳实践](#541-最佳实践)
  - [55. <a name='LRU'></a>LRU高效率算法](#55-lru高效率算法)
  - [56. <a name='-1'></a>最小生成树算法](#56-最小生成树算法)
  - [57. <a name='-1'></a>图的最短路径算法](#57-图的最短路径算法)
  - [58. <a name='-1'></a>排序算法总结：](#58-排序算法总结)
    - [58.1. <a name='-1'></a>十种常见算法的归类](#581-十种常见算法的归类)
    - [58.2. <a name='-1'></a>十种常见算法的复杂度对比](#582-十种常见算法的复杂度对比)
- [Redis](#redis)
  - [59. <a name='redismemchache'></a>redis和memchache 的 一些区别，使用总结](#59-redis和memchache-的-一些区别使用总结)
  - [60. <a name='hotkeybigkeyredis'></a>hot key与big key在redis中的问题](#60-hot-key与big-key在redis中的问题)
  - [61. <a name='redis-cluster'></a>redis-cluster设计](#61-redis-cluster设计)
  - [62. <a name='Redis-cluster'></a>Redis-cluster的同步？](#62-redis-cluster的同步)
  - [63. <a name='Skiplist'></a>跳表（Skiplist）与其他数据结构的对比](#63-跳表skiplist与其他数据结构的对比)
  - [64. <a name='Zset'></a>Zset](#64-zset)
  - [65. <a name='Redis'></a>Redis定义了几种策略用来处理内存满，需要淘汰的情况：](#65-redis定义了几种策略用来处理内存满需要淘汰的情况)
  - [66. <a name='RedisHASH'></a>Redis里的HASH](#66-redis里的hash)
    - [66.1. <a name='rehash'></a>渐进式rehash](#661-渐进式rehash)
  - [67. <a name='RedissdsC'></a>Redis 使用 sds 而不是传统 C 字符串的原因](#67-redis-使用-sds-而不是传统-c-字符串的原因)
- [MySQL与DB](#mysql与db)
  - [68. <a name='-1'></a>什么是共享锁和排它锁](#68-什么是共享锁和排它锁)
  - [69. <a name='InnoDB'></a>InnoDB底层怎么实现不同的事务隔离级别？](#69-innodb底层怎么实现不同的事务隔离级别)
  - [70. <a name='InnoDBMyISAM'></a>InnoDB和MyISAM的最大不同点有两个：](#70-innodb和myisam的最大不同点有两个)
  - [71. <a name='MyISAMWhydoesMysqlInnoDBintroduceBtreeforindexesinsteadofBtreeorhashmap'></a>MyISAM不适合高并发。Why does Mysql（InnoDB）introduce B+ tree for indexes instead of B tree or hashmap?](#71-myisam不适合高并发why-does-mysqlinnodbintroduce-b-tree-for-indexes-instead-of-b-tree-or-hashmap)
  - [72. <a name='MYSQL'></a>MYSQL 里头的锁](#72-mysql-里头的锁)
  - [73. <a name='-1'></a>数据库的三范式：](#73-数据库的三范式)
  - [74. <a name='-1'></a>数据库视图](#74-数据库视图)
  - [75. <a name='-1'></a>索引未命中可能原因的场景](#75-索引未命中可能原因的场景)
  - [76. <a name='MySQL'></a>MySQL中的删除语句](#76-mysql中的删除语句)
  - [77. <a name='MySQL-1'></a>MySQL的聚簇索引与非聚簇索引](#77-mysql的聚簇索引与非聚簇索引)
# 分布式架构与PHP

##  1. <a name=''></a>什么是服务注册与服务发现？
...
##  2. <a name='-1'></a>分布一致性算法：

Raft， Paxos

##  3. <a name='Sentinel'></a>Sentinel系统

###  3.1. <a name='Sentinel-1'></a>**Sentinel集群故障检测**
...
###  3.2. <a name='Sentinel-1'></a>**Sentinel集群故障转移**
...
##  4. <a name='Split-Brain'></a>脑裂（Split-Brain）
...
##  5. <a name='CDNCDN'></a>静态资源上传CDN后，向CDN访问该资源怎么做？
...
##  6. <a name='Nginx'></a>Nginx模式的常见复杂均衡方式
...
##  8. <a name='2Gmalloc20Gnew20G'></a>在一台内存为2G的机器上，malloc(20G) 会怎样？如果是new(20G) 会怎样？
...
##  9. <a name='Functor'></a>Functor 仿函数
...
##  10. <a name='NewDelete'></a>New, Delete：
...
##  13. <a name='Ccasthttps:www.cnblogs.comwelfarearticles336091.html'></a>[C++的四种cast操作符的](https://www.cnblogs.com/welfare/articles/336091.html)

###  13.1. <a name='C-1'></a>C风格转换
...
##  17. <a name='CJava'></a>C++类三种方式控制权限总结如下，这与Java中的三种对应的访问权限是一样的。
...
##  19. <a name='CString2021'></a>C++的String深入讨论（百度2021秋招）
...
##  20. <a name='CSTLmap'></a>C++中STL的map不同插入模式的性能对比

1．使用中括号插入m[key] = value; //本质先置key对应value为默认再置为实际值

2．使用insert，直接插入，效率高一些

##  21. <a name='STLunordered_map'></a>STL中的unordered_map怎么避免冲突？

**链地址法**

##  22. <a name='C-1'></a>C++智能指针：
...
###  22.1. <a name='C-1'></a>C++引用计数（智能指针相关）

![](media/950849bfe8a36e1d3af350bd8239ce1b.png)

##  23. <a name='C-1'></a>C++ 中的存储周期：
...
##  31. <a name='TCP-1'></a>TCP第三次握手失败后怎么办？
...
##  33. <a name='CA'></a>浏览器是如何对CA证书进行验证的？
...
##  38. <a name='GetPost'></a>Get与Post的对比

1.  Get产生一个TCP， Post产生两个TCP

2.  Get中的参数通过url传递，Post的参数在request body里头

##  39. <a name='HTTPHeader'></a>HTTP Header的内容
...
##  40. <a name='-1'></a>怎样理解阻塞非阻塞与同步异步的区别？
...
##  42. <a name='-1'></a>**什么是线程安全？**

（2012年5月百度实习生面试）

如果多线程的程序运行结果是可预期的，而且与单线程的程序运行结果一样，那么说明是“线程安全”的。

##  43. <a name='OS'></a>OS的分级保护域

![](media/42588187ec08bb993569777b8958b26e.png)

##  44. <a name='-1'></a>操作系统怎么管理，组织内存，申请一块内存的时候究竟发生了什么？
...
##  45. <a name='-1'></a>操作系统从一个文件名，读取到具体的文件内容，实际干了什么事情？★★★★

>   Unix/Linux系统内部不使用文件名，而使用inode号码来识别文件。对于系统来说，文件名只是inode号码便于识别的别称或者绰号。

>   表面上，用户通过文件名，打开文件。实际上，系统内部这个过程分成三步：首先，系统找到这个文件名对应的inode号码；其次，通过inode号码，获取inode信息；最后，根据inode信息，找到文件数据所在的block，读出数据。

##  46. <a name='-1'></a>硬链接与软链接
...
##  48. <a name='LinuxIO'></a>Linux系统之IO多路复用
...
##  51. <a name='-1'></a>**回调函数和钩子函数的区别**

根本上，他们都是为了捕获消息而生的，但是钩子函数在捕获消息的第一时间就会执行，而回调函数是在整个捕获过程结束时，最后一个被执行的。

##  52. <a name='AVLBBTrie'></a>AVL树，红黑树，B树，B+树，Trie树都分别应用在哪些现实场景中？
...
##  53. <a name='1TB32GB'></a>海量数据排序——如果有1TB的数据需要排序，但只有32GB的内存如何排序处理？
...
##  54. <a name='-1'></a>*布隆过滤器*的原理，使用场景和注意事项
...
##  60. <a name='hotkeybigkeyredis'></a>hot key与big key在redis中的问题
...
##  61. <a name='redis-cluster'></a>redis-cluster设计
...
##  62. <a name='Redis-cluster'></a>Redis-cluster的同步？
...
##  67. <a name='RedissdsC'></a>Redis 使用 sds 而不是传统 C 字符串的原因
...
##  69. <a name='InnoDB'></a>InnoDB底层怎么实现不同的事务隔离级别？

是通过MVCC,即多并发版本控制

##  70. <a name='InnoDBMyISAM'></a>InnoDB和MyISAM的最大不同点有两个：
...
##  71. <a name='MyISAMWhydoesMysqlInnoDBintroduceBtreeforindexesinsteadofBtreeorhashmap'></a>MyISAM不适合高并发。Why does Mysql（InnoDB）introduce B+ tree for indexes instead of B tree or hashmap?
...
##  76. <a name='MySQL'></a>MySQL中的删除语句

Delete 删除行，DROP删除表，表字段或库，TRUNCATE删除表，快速且无日志；

##  77. <a name='MySQL-1'></a>MySQL的聚簇索引与非聚簇索引
